...
> UnifiedResultList v1_checks_all_results_get(status=status, check_id=check_id, end_date=end_date, page_size=page_size, result_type=result_type, region=region, check_type=check_type, start_date=start_date, page=page)
...
with pingera.ApiClient(configuration) as api_client:
    ...
    try:
        # Get all check results (regular and on-demand)
        api_response = api_instance.v1_checks_all_results_get(status=status, check_id=check_id, end_date=end_date, page_size=page_size, result_type=result_type, region=region, check_type=check_type, start_date=start_date, page=page)
...
> Dict[str, object] v1_checks_check_id_response_times_get(check_id, region=region, start_date=start_date, status=status, end_date=end_date)
...
with pingera.ApiClient(configuration) as api_client:
    ...
    try:
        # Get aggregated response time metrics for a specific check
        api_response = api_instance.v1_checks_check_id_response_times_get(check_id, region=region, start_date=start_date, status=status, end_date=end_date)
...
> Dict[str, object] v1_checks_status_history_get(status=status, check_id=check_id, end_date=end_date, region=region, start_date=start_date)
...
with pingera.ApiClient(configuration) as api_client:
    ...
    try:
        # Get time-bucketed status history metrics
        api_response = api_instance.v1_checks_status_history_get(status=status, check_id=check_id, end_date=end_date, region=region, start_date=start_date)
